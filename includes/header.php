 ...
 *   $pageKey   (dashboard|orders|production|stock|recipes|settings)
...
<div id="kg-app" class="kg-app" data-theme="<?= $initialDark ? 'dark' : 'light' ?>">
  ...
  <div class="kg-nav">
    ...
    <a href="production.php" class="<?= $pageKey === 'production' ? 'active' : '' ?>"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 20h20"/><path d="M4 20V10l8-7 8 7v10"/><rect x="9" y="13" width="6" height="7" rx="1"/></svg><span>ผลิต</span></a>
