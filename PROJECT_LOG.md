...
- **เซิร์ฟเวอร์จริง (VPS):** http://[VPS-IP-REDACTED]:8090/ — ดูรายละเอียดในหัวข้อ "การติดตั้งบน VPS" ด้านล่าง

## การติดตั้งบน VPS

รันอยู่ที่ **http://[VPS-IP-REDACTED]:8090/** บน VPS เดียวกับโปรเจคอื่น (iqbot, lottery-analytics)
โดยตั้งใจแยกให้ไม่ชนกับของเดิมทุกจุด:
...
- ทดสอบเว็บใหม่ผ่าน public IP จริง (http://[VPS-IP-REDACTED]:8090/) ทั้งอ่านและเขียนข้อมูลลง MySQL — ผ่านทั้งหมด
